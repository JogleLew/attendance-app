...
public class JGLocateActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        waitSign = (TextView) findViewById(R.id.wait);
        ...
        LatLng geolat =new LatLng(JGSignActivity.dataSet.getLatitude(),
                JGSignActivity.dataSet.getLongitude());
        ...
        coder.setOnGetGeoCodeResultListener(new OnGetGeoCoderResultListener() {
            ...
            public void onGetReverseGeoCodeResult(ReverseGeoCodeResult reverseGeoCodeResult) {
                ...
                poiData.clear();
                poiData.add(JGSignActivity.dataSet.getPosition());
                for (int i = 0; i < reverseGeoCodeResult.getPoiList().size(); i++) {
                    if (!JGSignActivity.dataSet.getPosition().equals(
        ...
        poiList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                JGSignActivity.dataSet.setPosition(poiData.get(i));
                finish();
            }
        });
